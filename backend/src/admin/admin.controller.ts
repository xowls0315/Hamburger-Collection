...
export class AdminController {
  ...
  @ApiOperation({
    summary: '맥도날드 메뉴 수집',
    description:
      '맥도날드 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  ...
  @ApiOperation({
    summary: '버거킹 메뉴 수집',
    description:
      '버거킹 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
  ...
  @ApiOperation({
    summary: '롯데리아 메뉴 수집',
    description:
      '롯데리아 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
  ...
  @ApiOperation({
    summary: '맘스터치 메뉴 수집',
    description:
      '맘스터치 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
  ...
  @ApiOperation({
    summary: 'KFC 메뉴 수집',
    description:
      'KFC 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
  ...
  @ApiOperation({
    ...
    description:
      '노브랜드버거 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
  ...
  @ApiOperation({
    summary: '프랭크버거 메뉴 수집',
    description:
      '프랭크버거 메뉴를 스크래핑하여 데이터베이스에 저장합니다. (이미지 + 영양성분)',
  })
  @ApiResponse({ status: 201, description: '메뉴 수집 성공' })
  @ApiResponse({ status: 401, description: '인증 필요' })
