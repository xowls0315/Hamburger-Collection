  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto max-w-4xl">
        ...
        {/* 프로젝트 소개 */}
        <section className="mb-12 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900">
            프로젝트 소개
          </h2>
          <p className="mb-4 leading-relaxed text-gray-700">
            <strong>Hamburger-Collection</strong>은 국내 주요 햄버거 프랜차이즈 브랜드의
            메뉴 정보와 영양 성분을 한눈에 비교하고 탐색할 수 있는 웹 애플리케이션입니다.
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <BsFillMenuButtonWideFill className="mr-2 inline text-orange-500" />
                브랜드별 메뉴 탐색
              </h3>
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <IoLocationOutline className="mr-2 inline text-orange-500" />
                매장 찾기
              </h3>
              <p className="mb-3 text-sm text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <LuClipboardList className="mr-2 inline text-orange-500" />
                게시판
              </h3>
              <p className="mb-3 text-sm text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <FaStar className="mr-2 inline text-orange-500" />
                즐겨찾기
              </h3>
              <p className="mb-3 text-sm text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <FaUserCircle className="mr-2 inline text-orange-500" />
                사용자 인증
              </h3>
              <p className="mb-3 text-sm text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
              <h3 className="mb-2 text-lg font-semibold text-gray-900">
                <FaMagnifyingGlass className="mr-2 inline text-orange-500" />
                메뉴 검색
              </h3>
              <p className="mb-3 text-sm text-gray-700">
        ...
        {/* 시작하기 */}
        <section className="rounded-lg border border-gray-200 bg-orange-50 p-6 shadow-sm">
          <h2 className="mb-4 text-2xl font-semibold text-gray-900">
            시작하기
          </h2>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/board"
              className="rounded-lg border border-orange-500 bg-white px-6 py-3 font-medium text-orange-500 transition-colors hover:bg-orange-50"
            >
              게시판 보기
            </Link>
          </div>
